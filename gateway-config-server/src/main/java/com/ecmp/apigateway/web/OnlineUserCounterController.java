...
import com.ecmp.apigateway.model.BaseResult;
import com.ecmp.apigateway.model.QueryDTO;
import com.ecmp.apigateway.service.impl.UserCountService;
...
public class OnlineUserCounterController {
    ...
    public BaseResult<Map<Date,Double>> rangCounter(@Validated QueryDTO queryDTO, BindingResult bindingResult){
        ...
        try {
            return new BaseResult<>(userCountService.getRangCounter(queryDTO.getInterval()));
        }catch (Exception ex){
