    ...
    initGridCfg: function () {
        ...
        return {
            ...
            colModel: [
                ...
                {name: 'serviceAppName', index: 'serviceAppName', sortable: true, width: 300, label: g.lang.serviceAppNameText},
                //serviceAppRemarkText: 说明
                {name: 'serviceAppRemark', index: 'serviceAppRemark', sortable: true, width: 300, label: g.lang.serviceAppRemarkText},
                //serviceAppVersionText: 版本
                {name: 'serviceAppVersion', index: 'serviceAppVersion', sortable: true, width: 300, label: g.lang.serviceAppVersionText}
            ],
            rowNum: 15,
            shrinkToFit: false,
